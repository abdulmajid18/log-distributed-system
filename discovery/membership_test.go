...
//setupMember() sets up a new member under a free port and with the member’s
//length as the node name so the names are unique
...
//Mock handler struct that implements Handler interface
type handler struct {
